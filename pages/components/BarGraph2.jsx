...
const BarGraph2 = () => {
  ...
  const [newYear,setNewYear] = useState('2017')
  ...
  useEffect(() => {
      ...
      // if(newYear){
          ...
          // }
    // const filters = { year: newYear };
    
    console.log(newYear,'+++++++===');
    axios.post("./api/getAttendanceByYear", { year: newYear }).then(
        res => {
  ...
  return (
    <div ref={rootRef} className={styles.barGraph} >
      ...
      <div style={{color:'black'}} >
        <h2>ATTENDANCE ANALYSIS GRAPH FOR BATCH 2017</h2>
      </div>
